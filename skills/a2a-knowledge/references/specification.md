...
- [1. Introduction](#1-introduction)
  - [1.1. Key Goals of A2A](#11-key-goals-of-a2a)
  - [1.2. Guiding Principles](#12-guiding-principles)
  - [1.3. Specification Structure](#13-specification-structure)
  - [1.4 Normative Content](#14-normative-content)
- [2. Terminology](#2-terminology)
  - [2.1. Requirements Language](#21-requirements-language)
  - [2.2. Core Concepts](#22-core-concepts)
- [3. A2A Protocol Operations](#3-a2a-protocol-operations)
  - [3.1. Core Operations](#31-core-operations)
  - [3.2. Operation Parameter Objects](#32-operation-parameter-objects)
  - [3.3. Operation Semantics](#33-operation-semantics)
  - [3.4. Multi-Turn Interactions](#34-multi-turn-interactions)
  - [3.5. Task Update Delivery Mechanisms](#35-task-update-delivery-mechanisms)
  - [3.6 Versioning](#36-versioning)
  - [3.7 Messages and Artifacts](#37-messages-and-artifacts)
- [4. Protocol Data Model](#4-protocol-data-model)
  - [4.1. Core Objects](#41-core-objects)
  - [4.2. Streaming Events](#42-streaming-events)
  - [4.3. Push Notification Objects](#43-push-notification-objects)
  - [4.4. Agent Discovery Objects](#44-agent-discovery-objects)
  - [4.5. Security Objects](#45-security-objects)
  - [4.6. Extensions](#46-extensions)
- [5. Protocol Binding Requirements and Interoperability](#5-protocol-binding-requirements-and-interoperability)
  - [5.1. Functional Equivalence Requirements](#51-functional-equivalence-requirements)
  - [5.2. Protocol Selection and Negotiation](#52-protocol-selection-and-negotiation)
  - [5.3. Method Mapping Reference](#53-method-mapping-reference)
  - [5.4. Error Code Mappings](#54-error-code-mappings)
  - [5.5. JSON Field Naming Convention](#55-json-field-naming-convention)
  - [5.6. Data Type Conventions](#56-data-type-conventions)
  - [5.7. Field Presence and Optionality](#57-field-presence-and-optionality)
  - [5.8. Custom Binding Identification](#58-custom-binding-identification)
- [6. Common Workflows & Examples](#6-common-workflows-examples)
  - [6.1. Basic Task Execution](#61-basic-task-execution)
  - [6.2. Streaming Task Execution](#62-streaming-task-execution)
  - [6.3. Multi-Turn Interaction](#63-multi-turn-interaction)
  - [6.4. Version Negotiation Error](#64-version-negotiation-error)
  - [6.5. Task Listing and Management](#65-task-listing-and-management)
  - [6.6. Push Notification Setup and Usage](#66-push-notification-setup-and-usage)
  - [6.7. File Exchange (Upload and Download)](#67-file-exchange-upload-and-download)
  - [6.8. Structured Data Exchange](#68-structured-data-exchange)
  - [6.9. Fetching Authenticated Extended Agent Card](#69-fetching-authenticated-extended-agent-card)
  - [Step 2: Client obtains credentials (out-of-band OAuth 2.0 flow)](#step-2-client-obtains-credentials-out-of-band-oauth-20-flow)
  - [Step 3: Client fetches authenticated extended Agent Card](#step-3-client-fetches-authenticated-extended-agent-card)
- [7. Authentication and Authorization](#7-authentication-and-authorization)
  - [7.1. Protocol Security](#71-protocol-security)
  - [7.2. Server Identity Verification](#72-server-identity-verification)
  - [7.3. Client Authentication Process](#73-client-authentication-process)
  - [7.4. Server Authentication Responsibilities](#74-server-authentication-responsibilities)
  - [7.5. Server Authorization Responsibilities](#75-server-authorization-responsibilities)
  - [7.6. In-Task Authorization](#76-in-task-authorization)
- [8. Agent Discovery: The Agent Card](#8-agent-discovery-the-agent-card)
  - [8.1. Purpose](#81-purpose)
  - [8.2. Discovery Mechanisms](#82-discovery-mechanisms)
  - [8.3. Protocol Declaration Requirements](#83-protocol-declaration-requirements)
  - [8.4. Agent Card Signing](#84-agent-card-signing)
  - [8.5. Sample Agent Card](#85-sample-agent-card)
  - [8.6. Caching](#86-caching)
- [9. JSON-RPC Protocol Binding](#9-json-rpc-protocol-binding)
  - [9.1. Protocol Requirements](#91-protocol-requirements)
  - [9.2. Service Parameter Transmission](#92-service-parameter-transmission)
  - [9.3. Base Request Structure](#93-base-request-structure)
  - [9.4. Core Methods](#94-core-methods)
  - [9.5. Error Handling](#95-error-handling)
- [10. gRPC Protocol Binding](#10-grpc-protocol-binding)
  - [10.1. Protocol Requirements](#101-protocol-requirements)
  - [10.2. Service Parameter Transmission](#102-service-parameter-transmission)
  - [10.3. Service Definition](#103-service-definition)
  - [10.4. Core Methods](#104-core-methods)
  - [10.5. gRPC-Specific Data Types](#105-grpc-specific-data-types)
  - [10.6. Error Handling](#106-error-handling)
  - [10.7. Streaming](#107-streaming)
- [11. HTTP+JSON/REST Protocol Binding](#11-httpjsonrest-protocol-binding)
  - [11.1. Protocol Requirements](#111-protocol-requirements)
  - [11.2. Service Parameter Transmission](#112-service-parameter-transmission)
  - [11.3. URL Patterns and HTTP Methods](#113-url-patterns-and-http-methods)
  - [11.4. Request/Response Format](#114-requestresponse-format)
  - [11.5. Query Parameter Naming for Request Parameters](#115-query-parameter-naming-for-request-parameters)
  - [11.6. Error Handling](#116-error-handling)
  - [11.7. Streaming](#117-streaming)
- [12. Custom Binding Guidelines](#12-custom-binding-guidelines)
  - [12.1. Binding Requirements](#121-binding-requirements)
  - [12.2. Data Type Mappings](#122-data-type-mappings)
  - [12.3. Service Parameter Transmission](#123-service-parameter-transmission)
  - [12.4. Error Mapping](#124-error-mapping)
  - [12.5. Streaming Support](#125-streaming-support)
  - [12.6. Authentication and Authorization](#126-authentication-and-authorization)
  - [12.7. Agent Card Declaration](#127-agent-card-declaration)
  - [12.8. Interoperability Testing](#128-interoperability-testing)
- [13. Security Considerations](#13-security-considerations)
  - [13.1. Data Access and Authorization Scoping](#131-data-access-and-authorization-scoping)
  - [13.2. Push Notification Security](#132-push-notification-security)
  - [13.3. Extended Agent Card Access Control](#133-extended-agent-card-access-control)
  - [13.4. General Security Best Practices](#134-general-security-best-practices)
- [14. IANA Considerations](#14-iana-considerations)
  - [14.1. Media Type Registration](#141-media-type-registration)
  - [14.2. HTTP Header Field Registrations](#142-http-header-field-registrations)
  - [14.3. Well-Known URI Registration](#143-well-known-uri-registration)
- [Appendix A. Migration & Legacy Compatibility](#appendix-a-migration-legacy-compatibility)
  - [A.1 Legacy Documentation Anchors](#a1-legacy-documentation-anchors)
  - [A.2 Migration Guidance](#a2-migration-guidance)
  - [A.3 Future Automation](#a3-future-automation)
- [Appendix B. Relationship to MCP (Model Context Protocol)](#appendix-b-relationship-to-mcp-model-context-protocol)
